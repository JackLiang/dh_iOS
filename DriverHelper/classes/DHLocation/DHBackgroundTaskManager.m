...
@interface DHBackgroundTaskManager()
@property (nonatomic, strong)NSMutableArray* bgTaskIdList;
@property (assign) UIBackgroundTaskIdentifier masterTaskId;
@end

@implementation DHBackgroundTaskManager

+(instancetype)sharedDHBackgroundTaskManager{
    static DHBackgroundTaskManager* sharedBGTaskManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedBGTaskManager = [[DHBackgroundTaskManager alloc] init];
    });
